...
(comment
  (let [camera [7 6]
        ...
        cell-sm-x 200
        cell-sm-y 168
        left-lg 2 right-lg 12
        top-lg 2 bottom-lg 10
        left-sm 4 right-sm 10
        top-sm 4 bottom-sm 8]
    [(camera->viewport camera zoom-lg content-width content-height)
     (camera->viewport camera zoom-sm content-width content-height)
     (camera->viewport camera 1 content-width content-height)
     (camera->viewport camera 1.2 content-width content-height)
     zoom-lg cell-lg-x cell-lg-y [left-lg right-lg top-lg bottom-lg]
     zoom-sm cell-sm-x cell-sm-y [left-sm right-sm top-sm bottom-sm]]))
